...
public class InGameScoreBoard {
    ...
    public void setGameScoreboard(GamePlayer player) {
        ...
        players.setPrefix(ChatColor.GRAY + ">> " + ChatColor.GOLD + "Alive Players: " + game.getPlayers().size());
       ...
       TaskId = Bukkit.getScheduler().scheduleSyncRepeatingTask(Main.getInstance(), new Runnable() {
            ...
            public void run() {
                for (GamePlayer player : game.getPlayers()) {
                    ...
                    board.getTeam("AlivePlayers").setPrefix(ChatColor.GRAY + ">> " + ChatColor.GOLD + "Alive Players: " + game.getPlayers().size());
